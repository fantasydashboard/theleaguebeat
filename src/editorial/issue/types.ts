...
export interface IssueRow {
  ...
  progress?: {
    ...
    held?: boolean
    /** The other side of a race, drawn at the SAME weight — a chase
     *  with nobody to compare against is half a story, and a tie
     *  rendered as one full bar plus a footnote does not look tied. */
    against?: {
      name: string
      value: number
      logoUrl?: string
