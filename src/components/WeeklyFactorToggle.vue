    ...
    <div class="flex items-center gap-2 ml-2">
      ...
      >
        <input
          ...
          max="100"
          step="25"
          class="w-12 h-1 accent-cyan-500 cursor-pointer"
      ...
      <div 
        ...
        :class="factor.enabled ? 'bg-cyan-500' : 'bg-dark-border'"
      >
        <div 
...
import type { WeeklyFactorConfig } from '@/services/rankingFactors'

defineProps<{
  factor: WeeklyFactorConfig
  disabled?: boolean
}>()
